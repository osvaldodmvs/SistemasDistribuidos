...
public class Battle {
	/**A count of all the edu.ufp.inf.sd.rabbitmqservices._advancewars.client.game.players in the game, used before Game.player is populated so this is required.*/
	...
	public void NewGame(String mapname) {
		Game.player = new ArrayList<edu.ufp.inf.sd.rabbitmqservices._advancewars.client.game.players.Base>();
		Game.builds = new ArrayList<Base>();
		Game.units = new ArrayList<edu.ufp.inf.sd.rabbitmqservices._advancewars.client.game.units.Base>();
		Game.view.Loc.x = 0;
		Game.view.Loc.y = 0;
	...
	public void EndTurn() {
		...
		edu.ufp.inf.sd.rabbitmqservices._advancewars.client.game.players.Base ply = Game.player.get(currentplayer);
	...
	/**Grabs the number of edu.ufp.inf.sd.rabbitmqservices._advancewars.client.game.buildings a player owns.*/
	...
	public void MaxUsers(int max) {
		//Setup for max edu.ufp.inf.sd.rabbitmqservices._advancewars.client.game.players
		if (max<2) {totalplayers = 2;}
		else if (max>12) {totalplayers = 12;}
		else {totalplayers = max;}
		//HACK: Change when I add more images to support more edu.ufp.inf.sd.rabbitmqservices._advancewars.client.game.players.
	...
	public void CaptureCapital(int x, int y) {
		...
		//TODO: Change all edu.ufp.inf.sd.rabbitmqservices._advancewars.client.game.buildings to be owned by the player.
	}
