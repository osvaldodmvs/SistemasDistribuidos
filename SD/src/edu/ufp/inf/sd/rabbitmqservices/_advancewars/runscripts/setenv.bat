...
@REM ==== PC STUFF ====
@Set USERNAME=osvaldo

@Set WORKDRIVE=C
@Set JDK=%WORKDRIVE%:\Program Files\Java\jdk1.8.0_211
...
@Set FAULT_TOLERANCE_EXCHANGE_PREFIX=faulttolerance
...
@Set JAVA_LIBRARIES_DEPENDENCIES=%JAVA_LIB_FOLDER%\\jackson-annotations-2.14.2.jar;%JAVA_LIB_FOLDER%\\jackson-core-2.14.2.jar;%JAVA_LIB_FOLDER%\\jackson-databind-2.14.2.jar;%JAVA_LIB_FOLDER%\\java-jwt-4.4.0.jar

@REM Set CLASSPATH=%JAVAPROJ_CLASSES_FOLDER%;JAVA_RABBITMQ_TOOLS%
@REM Set CLASSPATH=%JAVAPROJ_JAR_FILE%
@Set CLASSPATH=.;%JAVAPROJ_JAR_FILE%;%JAVA_RABBITMQ_TOOLS%;%JAVA_LIBRARIES_DEPENDENCIES%
