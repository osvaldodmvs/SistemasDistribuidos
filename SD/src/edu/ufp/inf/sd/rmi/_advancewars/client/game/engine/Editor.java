...
public class Editor {
	...
	public void StartEditor(String name, int height, int width) {
		...
		Game.player = new ArrayList<edu.ufp.inf.sd.rmi._advancewars.client.game.players.Base>();
		Game.builds = new ArrayList<edu.ufp.inf.sd.rmi._advancewars.client.game.buildings.Base>();
	...
	public void AssButton() {
		...
		case CITY:
			AddBuilding();
			Game.map.map[selecty][selectx] = new edu.ufp.inf.sd.rmi._advancewars.client.game.terrain.City();
		break;
		case UNIT:
